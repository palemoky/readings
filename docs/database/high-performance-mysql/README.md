...
![MySQL 逻辑架构](imgs/mysql-logical-architecture.png)
...
![SessionB 的 ROLLBACK 操作使得 SessionA 的写入被撤销](imgs/transaction-rollback-prevent-dirty-write.png)
...
![ReadView 隔离级别判断过程](imgs/innodb-mvcc-read-view.png)
...
![MySQL 主从复制原理图](imgs/mysql-replication-principle.png)
...
![一个典型的读密集型网站负载均衡架构](imgs/load-balancing-read-intensive.png)
...
![redo log 的工作流程](imgs/innodb-redo-log-workflow.png)
