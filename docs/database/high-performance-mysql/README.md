...
<figure align="center">
	<img src="imgs/mysql-logical-architecture.png" alt="MySQL 逻辑架构" width="60%" /><br />
	<figcaption>MySQL 逻辑架构</figcaption>
</figure>
...
<figure align="center">
	<img src="imgs/mysql-replication-principle.png" alt="MySQL 主从复制原理图" width="60%" /><br />
...
<figure align="center">
	<img src="imgs/load-balancing-read-intensive.png" alt="一个典型的读密集型网站负载均衡架构"  /><br />
	<figcaption>一个典型的读密集型网站负载均衡架构</figcaption>
</figure>
...
<figure align="center">
	<img src="imgs/innodb-redo-log-workflow.png" alt="redo log 的工作流程" width="60%" /><br />
