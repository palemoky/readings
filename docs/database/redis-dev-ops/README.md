...
| **哈希 Hash**                                                                                                                         |                                                                                                                                                                                                                                                                                                                                                                   |                                                                                                               |                               |                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `hset key field valuehget key field`                                                                                                  |                                                                                                                                                                                                                                                                                                                                                                   |                                                                                                               | 设置值获取值                  | `_O_(1)                                                                                                           |
| _O_(1)`                                                                                                                               | 在 Redis 中，哈希类型是指键值本身又是一个键值对结构（形如 JSON）。哈希类型中的映射关系叫作field-value，注意这里的value是指field对应的值，不是键对应的值，请注意value在不同上下文的作用。                                                                                                                                                                          |
| `hdel key field [field ...]`                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                   | int （成功为删除的个数）                                                                                      | 删除 field                    | `*O*(*k*)` ，𝑘是field个数                                                                                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `hlen key`                                                                                                                            |                                                                                                                                                                                                                                                                                                                                                                   | int                                                                                                           | 计算 field 个数               | `*O*(1)`                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `hmset key field value [field value ...]hmget key field [field ...]`                                                                  |                                                                                                                                                                                                                                                                                                                                                                   |                                                                                                               | 批量设置或获取field-value     | `*O*(*k*)` ，𝑘是field个数*O*(_k_) ，𝑘是field个数                                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| 列表 List                                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                   |                                                                                                               |                               |                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `lpush key value [value ...]rpush key value [value ...]`                                                                              |                                                                                                                                                                                                                                                                                                                                                                   | int（成功插入元素个数）                                                                                       | 从左/右侧插入元素             | `*O*(*k*)`，𝑘 为元素个数                                                                                          | 列表类型的两个特点：<br/>1. 列表中的元素是有序的（即，可以通过索引下标获取元素）；<br/>2. 列表中的元素可以是重复的                                                                                                                                                                                                                                                                                                                             |
...
<figure align="center" markdown="span">
	![RDB 文件检测报告](imgs/006y8mN6ly1g8tfeooj3zj30k60hptbk.jpg){ width=60% }
	<figcaption>RDB 文件检测报告</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![AOF 重写流程图-1](imgs/006y8mN6ly1g8u1rzsipij30n811un3c.jpg){ width=60% }
	<figcaption>AOF 重写流程图-1</figcaption>
</figure>

<figure align="center" markdown="span">
	![AOF 重写流程图-2](imgs/006y8mN6ly1g8u27kw8tmj30u00ws7ff.jpg){ width=60% }
	<figcaption>AOF 重写流程图-2</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![AOF 追加阻塞流程](imgs/006y8mN6ly1g91c1tnqngj30ky0m3djy.jpg){ width=60% }
	<figcaption>AOF 追加阻塞流程</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![AOF 阻塞监控指标](imgs/006y8mN6ly1g91co0mb8fj30g40hz770.jpg){ width=60% }
	<figcaption>AOF 阻塞监控指标</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![Redis 主从复制原理](imgs/006y8mN6ly1g91e0yu7flj30if0o442t.jpg){ width=60% }
	<figcaption>Redis 主从复制原理</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![复制积压缓冲区](imgs/006y8mN6ly1g91vyy7e25j30h909875n.jpg){ width=60% }
	<figcaption>复制积压缓冲区</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![psync 命令执行流程](imgs/006y8mN6ly1g91xk5bba1j30jh0hejtq.jpg){ width=60% }
	<figcaption>psync 命令执行流程</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![全量同步流程](imgs/006y8mN6ly1g91xn7bm5rj30j30lqgp7.jpg){ width=60% }
	<figcaption>全量同步流程</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![全量复制时间开销](imgs/006y8mN6ly1g91xwacukej30hu0d8gnx.jpg){ width=60% }
	<figcaption>全量复制时间开销</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![规避全量复制的方法](imgs/006y8mN6ly1g91z58ncm8j30iv0frgpv.jpg){ width=60% }
	<figcaption>规避全量复制的方法</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![安全重启避免碎片](imgs/006y8mN6ly1g94c4oj8s0j30y20mmtfb.jpg){ width=60% }
	<figcaption>安全重启避免碎片</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![内存回收带来的写放大](imgs/006y8mN6ly1g94i0a1qirj30u00wg49h.jpg){ width=60% }
	<figcaption>内存回收带来的写放大</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![Redis 对象模型](imgs/006y8mN6ly1g94ig5abpxj30zi0u0tkp.jpg){ width=60% }
	<figcaption>Redis 对象模型</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![字符串预分配策略](imgs/006y8mN6ly1g97yccw87dj30kt0dq0w8.jpg){ width=60% }
	<figcaption>字符串预分配策略</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![Redis 性能优化手段总结](imgs/006y8mN6ly1g982kp4di3j30lh0fadim.jpg){ width=60% }
	<figcaption>Redis 性能优化手段总结</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![Leader 选举方法](imgs/006y8mN6ly1g99jg1aee3j30lk0nugmr.jpg){ width=60% }
	<figcaption>Leader 选举方法</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![绑定 CPU 核优化方案](imgs/006y8mN6ly1g9bh9fpgb4j311r0f6dhb.jpg){ width=60% }
	<figcaption>绑定 CPU 核优化方案</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![Sentinel 选举流程-1](imgs/006y8mN6ly1g99iv5r85rj30nu0f0weu.jpg){ width=60% }
</figure>

<figure align="center" markdown="span">
	![Sentinel 选举流程-2](imgs/006y8mN6ly1g99ixozs5oj30mk0hsgmn.jpg){ width=60% }
</figure>

<figure align="center" markdown="span">
	![Sentinel 选举流程-3](imgs/006y8mN6ly1g99iz0z3sqj30mc0fw3zq.jpg){ width=60% }
</figure>
...
<figure align="center" markdown="span">
	![故障转移流程](imgs/006y8mN6ly1g9cieyqdx2j30je0riwj1.jpg){ width=60% }
	<figcaption>故障转移流程</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![集群完整结构](imgs/006tNbRwly1g9i5gd6qalj30n80nowkd.jpg){ width=60% }
	<figcaption>集群完整结构</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![Gossip 消息头](imgs/006tNbRwly1g9ic768uakj30ho0m8jve.jpg){ width=60% }
	<figcaption>Gossip 消息头</figcaption>
</figure>

<figure align="center" markdown="span">
	![Gossip 消息体](imgs/006tNbRwly1g9icdly6hpj30j30ebq5o.jpg){ width=60% }
	<figcaption>Gossip 消息体</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![集群伸缩原理](imgs/006tNbRwly1g9icgp2fv1j30ju0gwtcv.jpg){ width=60% }
	<figcaption>集群伸缩原理</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![槽迁移数据流程](imgs/006tNbRwly1g9jh857qqpj30ji0ehq6u.jpg){ width=60% }
	<figcaption>槽迁移数据流程</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![收缩集群流程-1](imgs/006tNbRwly1g9jhell5zkj30gy0hc417.jpg){ width=60% }
	<figcaption>收缩集群流程-1</figcaption>
</figure>

<figure align="center" markdown="span">
	![收缩集群流程-2](imgs/006tNbRwly1g9jhkc00w3j30he0b3q5k.jpg){ width=60% }
	<figcaption>收缩集群流程-2</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![请求重定向流程](imgs/006tNbRwly1g9jhv81y3pj30j00jrwhp.jpg){ width=60% }
	<figcaption>请求重定向流程</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![ASK 重定向流程-1](imgs/006tNbRwly1g9qoovqnpwj30u00vlk0z.jpg){ width=60% }
	<figcaption>ASK 重定向流程-1</figcaption>
</figure>

<figure align="center" markdown="span">
	![ASK 重定向流程-2](imgs/006tNbRwly1g9qop67mnjj311m0ti0z1.jpg){ width=60% }
	<figcaption>ASK 重定向流程-2</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![故障转移时间线](imgs/006tNbRwly1g9qp56c761j30u010847e.jpg){ width=60% }
	<figcaption>故障转移时间线</figcaption>
</figure>
...
使用场景：应用方对于数据的一致性要求高，需要在真实数据更新后，立即更新缓存数据。 一致性：一致性最高，但如果主动更新发生了问题，那么这条数据很 likely 很长时间不会更新，所以**建议结合超时剔除一起使用效果会更好**。 维护成本：维护成本较高，开发者需要自己来完成更新，并保证更新操作的正确性。
...
<figure align="center" markdown="span">
	![缓存穿透逻辑](imgs/006y8mN6ly1g9belj4s0hj30i80p0dgl.jpg){ width=60% }
	<figcaption>缓存穿透逻辑</figcaption>
</figure>

<figure align="center" markdown="span">
	![布隆过滤器原理图](imgs/006y8mN6ly1g9bem3i667j30x20mcjse.jpg){ width=60% }
	<figcaption>布隆过滤器原理图</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![选举机制对比图](imgs/006y8mN6ly1g99na0qptwj30is0mgq4e.jpg){ width=60% }
	<figcaption>选举机制对比图</figcaption>
</figure>

<figure align="center" markdown="span">
	![选举时间线图](imgs/006y8mN6ly1g99nbf0c9pj30p40d43zk.jpg){ width=60% }
	<figcaption>选举时间线图</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![缓存一致性更新流程](imgs/006y8mN6ly1g9bcq960isj30v614q0tr.jpg){ width=60% }
	<figcaption>缓存一致性更新流程</figcaption>
</figure>

<figure align="center" markdown="span">
	![无底洞优化方案](imgs/006y8mN6ly1g9eo4ku5pyj30mg095acq.jpg){ width=60% }
	<figcaption>无底洞优化方案</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![缓存雪崩优化方案](imgs/006y8mN6ly1g9eobx2323j30m20ed0vb.jpg){ width=60% }
	<figcaption>缓存雪崩优化方案</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![热点 Key 重建方案对比](imgs/006y8mN6ly1g9eomw75jpj30lp0lt43y.jpg){ width=60% }
	<figcaption>热点 Key 重建方案对比</figcaption>
</figure>
...
<figure align="center" markdown="span">
	![Redis 攻击过程示意图](imgs/006tNbRwly1g9qrmwcp5ij30il0black.jpg){ width=60% }
	<figcaption>Redis 攻击过程示意图</figcaption>
</figure>
