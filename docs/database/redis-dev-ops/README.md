...
<div class="grid cards" markdown>
-  <figure>
    ![定时执行 info 命令](imgs/sentinel-info-task.jpg)
  </figure>
-  <figure>
    ![发布和订阅 _sentinel_hello 频道](imgs/sentinel-hello-channel.jpg)
  </figure>
-  <figure>
    ![向其他节点发送 ping 命令](imgs/sentinel-ping-task.jpg)
  </figure>
</div>
...
![MOVED 重定向流程](imgs/moved-redirect-flow.jpg){ align=right width=40% }
...
<div class="grid cards" markdown>
-  <figure>
    ![slot 迁移部分键](imgs/slot-migration-partial.jpg)
  </figure>
-  <figure>
...
<div class="grid cards" markdown>
-  <figure>
    ![将多个 key 分配到一个节点](imgs/hashtag-same-node.jpg)
  </figure>
-  <figure>
