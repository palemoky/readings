...
<figure markdown>
  ![HD 钱包](imgs/hd-wallet-key-tree.png){ width=60% }
  <figcaption>HD 钱包：从一个种子随机数中生成的一棵密钥树</figcaption>
</figure>

钱包的标准：
![随机数据的长度与助记词数量之间的关系](imgs/entropy-mnemonic-length.png){ align=right width=50% }
...
<figure markdown>
  ![EVM 的架构和执行上下文](imgs/evm-architecture.png){ width=60% }
...
![EIP 工作流](imgs/eip-process.png){ align=right width=60% }
