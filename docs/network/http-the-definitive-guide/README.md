...
Accept-Encoding字段包含用逗号分隔的支持编码的列表，如 - Accept-Encoding: compress, gzip - Accept-Encoding: - Accept-Encoding: _- Accept-Encoding: compress;q=0.5, gzip;q=1.0 - Accept-Encoding: gzip;q=1.0, identity; q=0.5,_ ;q=0
