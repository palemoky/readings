...
<div class="grid cards" markdown>
- <figure>
    ![慢启动和拥塞避免](imgs/tcp-slow-start-congestion-avoidance.png)
    <figcaption>慢启动和拥塞避免（Reno）</figcaption>
  </figure>
- <figure>
    ![快重传与快恢复](imgs/tcp-fast-retransmit-fast-recovery.png)
...
![DHCP 交换](imgs/dhcp-exchange-process.png){ align=left width=50% }
