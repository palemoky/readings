...
链接: https://book.douban.com/subject/23008813/
来源: 纸质书
封面: https://img1.doubanio.com/view/subject/l/public/s27783358.jpg
ISBN: 9787121198854

# 第 1 章 MySQL 架构与历史

![MySQL 逻辑架构](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled.png)
...
② 更新数据未命中索引
 | ① 写锁比读锁有更高的优先级
② 服务层会为诸如 ALTER TABLE 之类的语句使用表锁，而忽略存储引擎的锁机制 |
| 行锁 | 大 | 高 | ① 更新数据命中索引
② select ... for update | **行锁只在存储引擎层实现**，而 MySQL 服务层没有实现 |
...
![Untitled](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%201.png)

![Untitled](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%202.png)

![Untitled](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%203.png)

![SessionB 的 ROLLBACK 操作使得 SessionA 的写入被撤销](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%204.png)

SessionB 的 ROLLBACK 操作使得 SessionA 的写入被撤销
...
![Untitled](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%205.png)

![Untitled](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%206.png)
...
![聚簇索引与非聚簇索引对比图](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%207.png)

聚簇索引与非聚簇索引对比图

![聚簇索引结构与搜索过程示例](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%208.png)
...
![MySQL 主从复制原理图](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%209.png)
...
![一主多从](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2010.png)

一主多从

当从库足够多时，会对主库造成很大的负载，因为每个从库都会在主库上创建一个线程。通过分发库则可解决此问题，但同时会导致从库无法替代主库，因为分发库的存在，导致从库与主库的二进制日志坐标不同。

![主动-被动模式下的双主复制](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2011.png)

主动-被动模式下的双主复制

该模式下，当主库被锁而导致性能急剧下降或意外关机时，可用被动库替代主库以保证服务。

![主库-分发库-多备](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2012.png)
...
![一个典型的读密集型网站负载均衡架构](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2013.png)
...
![记录锁](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2014.png)

记录锁

![间隙锁](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2015.png)

间隙锁

![临键锁](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2016.png)
...
![redo log 的工作流程](%E3%80%8A%E9%AB%98%E6%80%A7%E8%83%BDMySQL%E3%80%8B/Untitled%2017.png)
