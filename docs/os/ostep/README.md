...
![进程状态转换](imgs/process-state-transition.png){ align=right width=30% }
进程的创建，需要以下步骤：
...
<figure markdown>
  ![进程的虚拟地址空间](imgs/process-address-space.png){ width=50% }
...
![哲学家就餐问题图示](imgs/dining-philosophers-problem.png){ align=right width=40% }
...
![磁盘结构](imgs/disk-structure.png){ align=left width=25% }
如图所示，磁盘结构：
...
- <figure>
    ![RAID 0~6](imgs/raid-levels-0-to-6.png)
...
<figure markdown>
  ![文件系统结构图](imgs/file-system-structure.png){ width=80% }
...
<div class="grid cards" markdown>
- <figure>
    ![耗尽 inode 导致系统异常的示例 1](imgs/inode-exhaustion-example-1.jpeg)
    <figcaption>耗尽 inode 导致系统异常的示例 1</figcaption>
  </figure>
- <figure>
    ![耗尽 inode 导致系统异常的示例 2](imgs/inode-exhaustion-example-2.png)
...
![文件读取时间线](imgs/path-resolution-inode-updates.png){ align=left width=40% }
...
![文件创建时间线](imgs/file-creation-io-steps.png){ align=right width=40% }
创建文件的 I/O：
...
![现代 DBMS 数据写入顺序](imgs/modern-dbms-data-write.png){ align=right width=50% }
写缓冲的好处：
...
<div class="grid cards" markdown>
- <figure>
    ![ext2 结构](imgs/ext2-structure.png)
    <figcaption>ext2 结构</figcaption>
  </figure>
- <figure>
    ![ext3 的 Journal 结构](imgs/ext3-journal-structure.png)
    <figcaption>ext3 的 Journal 结构</figcaption>
  </figure>
- <figure>
    ![ext3 结构](imgs/ext3-structure.png)
    <figcaption>ext3 结构</figcaption>
  </figure>
- <figure>
    ![Journal 的超级块中记录最新和最旧事务](imgs/journal-superblock-oldest-newest.png)
