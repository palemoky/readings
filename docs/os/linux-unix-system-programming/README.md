...
![Unix 发展时间轴](imgs/unix-history-timeline.png){ align=right width=50% }
...
![进程内存布局](imgs/process-memory-layout.png){ align=right width=50% }
...
![进程间通信方式](imgs/ipc-mechanisms.png){ align=right width=50% }
...
![IPv6 地址格式](imgs/ipv6-address-format.png){ align=right width=40% }
...
![netstat 输出示例](imgs/netstat-output.png){ align=right width=50% }
