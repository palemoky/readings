...
[分层协议](../../network/how-networks-work/README.md#协议层)如此强大和灵活的其中一个原因是**透明**——每一个协议层都对上层隐藏下层的操作和复杂性，如一个使用 TCP 的应用程序值需要使用标准的是 socket API 并清楚自己正在使用意向可靠的字节流传输服务，而无需理解 TCP 操作的细节。
