...
![类的冰山定律：暴露部分和隐藏细节](imgs/class-iceberg-analogy.png){ align=right width=20% }
...
![直线型代码的相关语句组织方式](imgs/straight-line-code-organization.png){ align=right width=40% }
...
如何开发出高质量的程序？
![开发高质量程序的流程](imgs/software-quality-development-process.png){ align=right width=50% }
...
![大型项目中沟通复杂度的增加](imgs/large-project-communication-complexity.png){ align=right width=50% }
...
- 为评估留出时间，并作出计划
  ![布鲁克斯法则：为落后项目增加人手会使进度延后](imgs/brooks-law-adding-manpower.png){ align=right width=40% }
